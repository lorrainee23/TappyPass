...
@section('title', 'Add Route - TappyPass Admin')
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form action="{{ route('admin.routes.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="available_seats" value="{{ old('available_seats', 50) }}" min="1" required
                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <div class="flex gap-3">
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded">
                <i class="fas fa-save mr-2"></i>Create Route
            </button>
